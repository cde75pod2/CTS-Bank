...
<body >
	...
	<ul>
		...
		<li><div class="navbar-brand">CTS Bank</div></li>
		<li style="float:right"><a class="active"  href="/logout">Logout</a></li>
		</ul>
	<br>
		<h1 align="center">Welcome to CTS Bank</h1>
		<p align="center">"We Understand Your World"</p>
				...
				<div class="card" style="width:360px;height:250px;background: rgb(0, 0, 0); /* Fallback color */
					...
					<div class="card-body">
						...
						<form action="/deposit" method="post">
							<input type="number"  name="accountId" placeholder="Enter the Account No." autocomplete="off"/><br><br>	
